...
void ShowMeasurePage(void)
{
	...
	double lToleranceUpperLimit,lToleranceLowerLimit,lTUpperLimitWarning,lTLowerLimitWarning;
...
//			else ShowSettingPage5();					//显示设置页面5
		...
		case ERROR_PAGE:
			...
			{
				set_ScreenPageID(ScreenPageInfo.uLastPageID);			//极值页面按键响应处理
			}
			else ShowErrorPage();					//显示极值页面
		default:
			break;
	}
}
